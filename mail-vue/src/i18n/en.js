const en = {
    ...
    noSearchResults: 'No emails found',
    ...
    archive: 'Archive',
    archiveSuccessMsg: 'Archived',
    undo: 'Undo',
    swipeActionFailMsg: 'Action failed, please try again',
    undoFailMsg: 'Could not undo, please try again',
    ...
    imagesBlocked: 'Blocked {count} remote image(s) to protect your privacy',
    imagesShown: 'Remote images shown',
    attachmentRiskTitle: 'Attachment safety warning',
    download: 'Download anyway',
    attachmentRiskExecutable: 'This is an executable file (.{ext}); opening it can run code',
    attachmentRiskDouble: 'The name hides a second extension (.{ext}), a common disguise for a dangerous file',
    attachmentRiskActive: 'This is active content the browser will run (.{ext})',
    attachmentRiskMacro: 'This document contains macros (.{ext}), which can run code',
    message: 'Mail',
    language: 'Language',
    ...
    pushStatusDenied: 'Blocked by the browser',
    pushStatusUnavailable: 'Not configured on the server',
    pushEnabledMsg: 'Mail notifications enabled',
    ...
    pushTestResult: 'Test notification sent: delivered to {sent}/{total} device(s)',
    pushTestNone: 'No registered device — enable notifications first',
