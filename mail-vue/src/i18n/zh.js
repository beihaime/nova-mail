const zh = {
    ...
    manageAddressesDesc: '管理连接到此账户的邮箱地址。',
    community: '交流',
    changeTitle: '修改标题',
    ...
    delSuccessMsg: '删除成功',
    archive: '归档',
    archiveSuccessMsg: '已归档',
    undo: '撤销',
    swipeActionFailMsg: '操作失败，请重试',
    undoFailMsg: '撤销失败，请重试',
    ...
    retry: '重试',
    showQuotedContent: '显示引用内容',
    bodyFrameTitle: '邮件正文',
    showImages: '显示图片',
    imagesBlocked: '为保护隐私，已阻止 {count} 张远程图片',
    imagesShown: '已显示远程图片',
    attachmentRiskTitle: '附件安全提醒',
    download: '仍要下载',
    attachmentRiskExecutable: '这是可执行文件（.{ext}），打开后可能运行代码',
    attachmentRiskDouble: '文件名含双重扩展名（.{ext}），常在伪装成普通文档时使用',
    attachmentRiskActive: '这是浏览器可直接运行的活动内容（.{ext}）',
    attachmentRiskMacro: '这是启用宏的文档（.{ext}），宏可以运行代码',
    message: '邮件详情',
    language: '系统语言',
    ...
    pushStatusOn: '已开启',
    pushStatusOff: '未开启',
    pushStatusUnsupported: '浏览器不支持',
    pushStatusDenied: '已被浏览器拒绝',
    pushStatusUnavailable: '服务端未配置',
    pushEnabledMsg: '已开启邮件通知',
    pushDeniedMsg: '通知权限被拒绝，请在浏览器设置中允许后重试',
    pushUnsupportedMsg: '当前浏览器不支持通知',
    pushUnavailableMsg: '服务器未配置推送密钥，暂时无法开启',
    pushTest: '发送测试通知',
    pushTestResult: '测试通知已发送：{sent}/{total} 台设备送达',
    pushTestNone: '没有已注册的设备，请先开启通知',
    openInNewTab: '在新标签打开',
    icon: '图标',
    position: '位置',
    offset: '偏移距离',
    ...
    connectGoogleDesc: '连接你的 Google 账户',
    ...
    googleNotLinked: '此 Google 账户尚未连接到 Nova Mail。请先使用密码登录，再到设置中连接账户。',
    googleLoginFailed: '无法完成 Google 登录，请重试。',
    googleAuthorizationCancelled: 'Google 授权已取消。',
    googleDisconnected: 'Google 账户已解除连接',
    googleConnected: 'Google 账户连接成功',
    disconnectGoogleConfirm: '要解除此 Google 账户吗？之后将无法再用它登录。',
}
export default zh
