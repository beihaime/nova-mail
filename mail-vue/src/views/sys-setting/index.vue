            ...
            <div class="card-content">
              <div class="concerning-item">
                ...
                <el-badge is-dot :hidden="!hasUpdate">
                  <el-button @click="jump('https://github.com/beihaime/nova-mail/releases')">
                    {{ currentVersion }}
                    <template #icon>
              ...
              <div class="concerning-item">
                ...
                <div class="community">
                  <el-button @click="jump('https://github.com/beihaime/nova-mail')">
                    Github
                    <template #icon>
...
function getUpdate() {
  ...
  axios.get('https://api.github.com/repos/beihaime/nova-mail/releases/latest').then(({data}) => {
